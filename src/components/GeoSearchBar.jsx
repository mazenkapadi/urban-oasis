...
const GeoSearchBar = ({ onGeoSearch }) => {
    ...
    const handleInputChange = (inputValue) => {
        if (!inputValue) {
            // Clear input when the user deletes content
            setCityInput(null);
            onGeoSearch(null);
        }
    };
...
//         // Clear input and reset search if Backspace is pressed and field is empty
//         if (event.key === "Backspace" && !cityInput) {
//             setCityInput(""); // Clear the input field
//             if (onGeoSearch) {
//                 onGeoSearch(null); // Reset the search results
//             }
//         }
//     };
//
...
//                     className:
//                         "w-full h-12 px-4 text-gray-700 focus:ring focus:ring-blue-300 focus:outline-none",
//                     styles: {
//                         control: (provided) => ({
//                             ...provided,
//                             height: "3rem", // Ensure height matches h-12
