...
function AuthLeftComponent() {
    return (
        <div className="flex w-full items-center justify-center h-screen bg-primary-dark p-8" >
            <div className="leftColumn w-full max-w-lg p-8" >
                <h2 className="text-4xl text-primary-light mb-8 font-archivo" >Urban Oasis</h2 >
                <div className="flex items-start mb-6" >
                    <CalendarDaysIcon className="h-6 w-6 text-gray-400 mr-4 mt-1" />
                    <div >
                        <h4 className="text-lg font-semibold text-primary-light mb-2" >Connect Your Community</h4 >
                ...
                <div className="flex items-start mb-6" >
                    ...
                    <div >
                        <h4 className="text-lg font-semibold text-primary-light mb-2" >Ease of Use</h4 >
                ...
                <div className="flex items-start mb-6" >
                    ...
                    <div >
                        <h4 className="text-lg font-semibold text-primary-light mb-2" >Flexibility</h4 >
