            ...
            <div
                ...
                <div className="pb-10">
                    <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-8 pt-24 pb-10">
                        ...
                        <div className={`rounded-lg shadow-lg p-6 space-y-2 ${darkMode ? "bg-primary-dark" : "bg-primary-light"}`}>
                            ...
                            <div className="flex space-x-8 pb-36">
                                <List className={` space-y-12 ${darkMode ? "text-primary-light" : "text-primary-dark"}`}>
                                    <ListItem>
                        ...
                        <div className={`rounded-lg shadow-lg p-6 space-y-8 ${darkMode ? "bg-primary-dark" : "bg-primary-light"}`}>
                            <div>
                                <Typography variant="span" component="div"
                                ...
                                <div className={`mb-4 border-b-2 pb-2 ${darkMode ? "border-Light-L2" : "border-Dark-D2"}`}></div>
                            </div>
                                    ...
                                    reviewDetails.map((review, index) => (
                                        <Card key={index}
                                            ...
                                            <CardContent>
                                                ...
                                                <Typography variant="body2" color={`${darkMode ? colors["Light-L2"] : colors["Dark-D2"]}`}
                                                            sx={{
                                                                marginTop: '8px',
                                                                fontSize: '20px',
                                                                whiteSpace: 'pre-line',
                    ...
                    <div className={`rounded-lg shadow-lg p-6 space-y-2 ${darkMode ? "bg-primary-dark" : "bg-primary-light"}`}>
                        <span className={`text-h4 font-bold mb-1 ${darkMode ? "text-primary-light" : "text-primary-dark"}`}>This Host's Events</span>
                        <Swiper
                        ...
                        >
                            {displayedEvents.length > 0 ? (
                                ...
                                <div className={`text-body text-Dark-D1 dark:text-Light-L1 text-center mt-8 w-full ${darkMode ? "text-Light-L1" : "text-Dark-D1"}`}>No
            ...
            <Modal open={modalOpen} onClose={handleModalClose}>
                <div
                    ...
                    <h3 className={`text-h3 font-semibold mb-4 text-center font-archivo ${darkMode ? "text-primary-dark" : "text-primary-light"}`}>Review
                        Sent</h3>
                    <span className={`text-body text-center mb-6 font-inter ${darkMode ? "text-Dark-D2" : "text-Light-L2"}`}>
