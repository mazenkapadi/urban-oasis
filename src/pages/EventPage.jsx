                    ...
                    <div className="bg-blue-800 p-6 flex flex-col w-full h-full gap-3">
                        <div
                            ...
                            <div className="flex flex-row">
                                <div className="flex content w-full flex-col gap-8 ">
                                    ...
                                    <div className="flex flex-row pt-4">
                                        ...
                                        <label className="font-bold text-white opacity-50 pl-3">Date and
                                            Time</label>
                                    </div>
                                ...
                                <div className="flex flex-col p-6 w-1/4 h-52 gap-2">
                                    <div
                                        ...
                                        <div
                                            className="box-border rounded-lg bg-gray-500 bg-opacity-30 border-4 border-gray-500 justify-center items-center flex w-24 h-12 gap-3">
                            ...
                            <div className="flex flex-row justify-between">
                                <div
                                    className="p-2 flex w-1/2 h-fit">
                            ...
                            <div
                                className="box-border rounded-lg bg-gray-500 bg-opacity-30 border-4 border-gray-500 p-2 flex w-1/3 h-28">
                                <label className="font-bold text-white text-2xl">Host Contact Information</label>
                            </div>
